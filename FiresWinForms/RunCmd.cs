...
namespace FiresWinForms
{
    ...
    {
        public static string Run(string cmd, string path, int num, string horizontalVals = "", string verticalVals = "", bool save = false)
        {
            ProcessStartInfo start = new ProcessStartInfo
            {
                FileName = cmd,
                Arguments = string.Format("\"{0}\" {1} {2} {3} {4}", path, num, ((save) ? "save" : "show"), horizontalVals, verticalVals),
